  ...
  vms = [
    {
      ...
      vpc_name = "ps_release_can_vpc_001"
      subnet_id = module.release_network.subnet_ids["ps-release-can-subnet-001"]
      security_group_id = module.release_network.security_group_ids["abc"]
      tier = "app"
    },
    {
      ...
      security_group_id = module.release_network.security_group_ids["xyz"]
      tier = "web"
    },
  ]
}
